...
from libs.keyboard.diag_keyboard import DiagKeyboard
from libs.keyboard.compat_keyboard import CompatKeyboard
from libs.keyboard.gui_keyboard import GUIKeyboard

class CtrlKeyboard(CtrlDev):
	...
	def __init__(self, parent):
		...
		self._diag = DiagKeyboard(self)
		self._compat = CompatKeyboard(self)
		self._guiClass = GUIKeyboard

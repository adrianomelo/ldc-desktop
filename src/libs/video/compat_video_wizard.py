...
class VideoWizard(QtGui.QWizard, Ui_Wizard):
	...
	def __init__(self, parent, info, screenNumber):
	...
	def __adjusts(self):
		...
		self.setPage(self.PLAY, self.videoplay)
...
#		print "DEBUG: Current: %s" % newId
	...
	def yesClicked(self):
		...
		msg = "Placa de vídeo compatível com o Librix Desktop. \n\nClique no botão <b>Concluir</b>."
	...
	def noClicked(self):
		...
		msg = "Falha no teste de vídeo. \n\nSua placa de vídeo não está corretamente configurada ou é incompatível com o Librix."
		self.successLabel.setText(QtGui.QApplication.translate("Wizard", msg, None, QtGui.QApplication.UnicodeUTF8))
...
#
#		videoSample = "/media/cdrom/D.Gray-Man_-_Ep_01_[Aya][B1AEE23C].mp4"
#		application = "vlc-wrapper --xvideo-altfullscreen --xvideo-xineramascreen 1 --fullscreen %s" % videoSample
#
#		outputString, errorString, processReturnCode = executor.executeCommandAndWait(True, None, application)
#
#		print outputString
#		print errorString
#
#		os.system('killall vlc-wrapper')
#		self.nextButton.setEnabled(True)